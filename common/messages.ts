...
import { PlayerComponent } from "../client/src/components/playerComponent";
...
// # Classe *NetworkScore*
// Ce message représente un changement dans les score des joueurs.
export class NetworkScore extends NetworkMessage {
  // ## Constante *typeCode*
  // Représente l'identifiant numérique de ce message
  public static typeCode = 101;
  ...
  // Initialise les valeurs lors de la création d'une nouvelle
  // instance de ce message.
  public build(player: PlayerComponent) {
    this.typeCode = NetworkScore.typeCode;
    this.score = player.score.value;
    this.name = player.name;
  }

  public build2(n :string, s : number){
    this.typeCode = NetworkScore.typeCode;
    this.score=s;
    this.name = n;
  }
